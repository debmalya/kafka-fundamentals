...
public class TransactionalProducer {
	...
	public static void main(String[] args) {
		...
		props.put(ProducerConfig.ACKS_CONFIG, "all"); // default RF = 1, ISR = 1 must be all for transaction
		props.put(ProducerConfig.LINGER_MS_CONFIG, 0); // send data by record, without packing
